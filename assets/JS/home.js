...
function sortByTime(){
    ...
    apptArray.sort((a,b) => a.dayAndTime.dateTime - b.dayAndTime.dateTime);
}
...
apptArray.push(createAppointment(
    ...
    createDayAndTime('2023-03-08T10:30:00')
...
apptArray.push(createAppointment(
    ...
    createDayAndTime('2024-03-14T09:00:00')
...
apptArray.push(createAppointment(
    ...
    createDayAndTime('2024-12-05T13:50:00')
...
apptArray.push(createAppointment(
    ...
    createService('flea and tick treatment', 'skin and coat'),
    createDayAndTime('2024-04-27T11:30:00')
));
...
apptArray.push(createAppointment(
    ...
    createService('nail trim', 'basic grooming'),
    createDayAndTime('2025-01-10T08:45:00')
));
...
apptArray.push(createAppointment(
    ...
    createService('nail trim', 'basic grooming'),  
    createDayAndTime('2024-12-05T07:00:00')
));
